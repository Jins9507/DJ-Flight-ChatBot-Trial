		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DJ_Chatbot_AI",
									"targetURL": "#chatbotdjchatbotai-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chatbotdjchatbotai-display": {
								"semanticObject": "chatbotdjchatbotai",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chatbot.djchatbotai",
									"url": sap.ui.require.toUrl("chatbot/djchatbotai")
								}
							}
						}
					}
